...
// Add the salesman collection grouping logic inside renderColSummary
const search1 = `  document.getElementById('col-summary').innerHTML=\`<div class="date-summary">
    <div class="ds-left">
...
const replace2 = `function openSalesmanColModal(sm) {
  ...
  let html = items.map(i => \`<div style="display:flex;justify-content:space-between;padding:12px 0;border-bottom:1px solid var(--border)">
    <div>
      ...
      <div style="font-size:12px;color:var(--mu);margin-top:2px">\${esc(i.mode)} · \${fmtDateShort(i.date)}</div>
    </div>
